...
Zettelkasten 编号目录有严格的子目录规范（定义在 CLAUDE.md 的 Directory Structure 表中）。任何不在规范中的目录都是潜在问题——可能是手动创建的临时目录、测试目录或误操作。

规范目录白名单：
- `00-Dashboard/`
- `10-Inbox/Fleeting/`, `10-Inbox/Clippings/`
- `20-Sources/`
- `30-Notes/Permanent/`, `30-Notes/Entity/`, `30-Notes/Comparison/`, `30-Notes/Hypothesis/`
- `40-Maps/`
- `50-Research-Log/`
- `60-Outputs/`
- `70-Archive/`
...
修复方向：文件应移到正确目录（如 `30-Notes/Research/` 中的报告应移到 `60-Outputs/`），然后删除空目录。
